<script lang="ts" setup>
    ...
    const config = ref<Partial<QrCodeProps>>({
...
<template>
    <custom-modal-wrapper preset="card" size="small" title="二维码">
        <template #trigger="{ toggle }">
            <custom-naive-button icon="i-ant-design:qrcode-outlined" @click="toggle"
                >二维码</custom-naive-button
            >
        </template>
