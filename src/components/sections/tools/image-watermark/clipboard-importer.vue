...
<template>
            ...
            <custom-naive-auto-stack justify="center">
                <template v-for="item in files">
                    <custom-naive-vertical-stack>
                        ...
                        <custom-naive-button size="small" @click="handleSelect(item)"
                            >选择</custom-naive-button
                        >
                    </custom-naive-vertical-stack>
                </template>
    ...
    <custom-naive-button icon="i-tabler:clipboard" @click="handleRead"
        >从剪贴板读取</custom-naive-button
    >
</template>