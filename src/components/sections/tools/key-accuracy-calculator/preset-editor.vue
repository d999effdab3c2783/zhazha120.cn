...
<template>
    <custom-naive-vertical-stack>
        ...
        <n-form-item label="谱面列表">
            <n-dynamic-input
                v-model:value="keyAccuracyCalculatorStore.editPreset.maps"
                @create="keyAccuracyCalculatorStore.createMap()"
            >
        ...
        <custom-naive-position placement="center">
            <n-form-item label="过段要求">
                <custom-naive-vertical-stack :size="12">
                    <n-slider
                        v-model:value="keyAccuracyCalculatorStore.editPreset.require_accuracy"
                        :max="100"
                        :min="0"
                        :step="0.01"
                    />
