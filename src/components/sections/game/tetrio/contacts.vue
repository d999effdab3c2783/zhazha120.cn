...
import type TetrioContact from '@/database/tables/tetrio_contact'
import { NCard } from 'naive-ui'
import { isEmptyish } from 'remeda'

defineOptions({
	name: 'SectionsGameTetrioContacts'
})

const items = useDatabase<TetrioContact[]>(async database => {
	return database.tetrio_contacts.toArray()
})
</script>
