<script lang="ts" setup>
	...
	const config = shallowReactive<Partial<QrCodeProps>>({
		...
		iconSize: 60,
		iconSrc: profileData.avatar.src,
...
<template>
	<custom-naive-ui-vertical-stack size="large">
		...
		<custom-naive-ui-auto-stack justify="space-evenly" size="large">
		...
		<custom-naive-ui-auto-stack justify="space-evenly" size="small">
			<custom-naive-ui-button :block="isMobile" @click="applyPreset('default')">默认样式</custom-naive-ui-button>
		</custom-naive-ui-auto-stack>
	</custom-naive-ui-vertical-stack>
</template>