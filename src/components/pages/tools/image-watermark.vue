...
import { NCard, NColorPicker, NDivider, NFormItem, NImage, NInput, NInputNumber, NSwitch, NWatermark } from 'naive-ui'
		...
		<n-card size="small">
			<custom-naive-vertical-stack align="center">
				<template v-if="isNonNullish(file)">
					...
					<custom-naive-button icon="i-ant-design:delete-outlined" secondary type="error" @click="file = undefined">重新选择</custom-naive-button>
				</template>
			...
			<n-card size="small">
				...
				<custom-naive-auto-stack justify="space-evenly">
					...
					<n-form-item label="字重">
						<n-input-number v-model:value="toolsImageWatermarkStore.config.fontWeight"/>
					</n-form-item>
					...
					<n-form-item label="全局旋转">
						<n-input-number v-model:value="toolsImageWatermarkStore.config.globalRotate"/>
					</n-form-item>

					<n-form-item label="行高">
						<n-input-number v-model:value="toolsImageWatermarkStore.config.lineHeight"/>
					</n-form-item>
					...
					<n-form-item label="图片高度">
						<n-input-number v-model:value="toolsImageWatermarkStore.config.imageHeight"/>
					</n-form-item>

					<n-form-item label="图片透明度">
						<n-input-number v-model:value="toolsImageWatermarkStore.config.imageOpacity"/>
					</n-form-item>

					<n-form-item label="图片宽度">
						<n-input-number v-model:value="toolsImageWatermarkStore.config.imageWidth"/>
					</n-form-item>
