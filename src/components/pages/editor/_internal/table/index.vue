...
import { type DataTableColumn, type DataTableRowData, NCard, NDataTable, NFlex } from 'naive-ui'
...
<template>
	<n-card size="small">
		...
		<n-flex size="small" vertical>
			<search :error="(filterError ?? null)" :table="table" :value="(query ?? '')" @update:value="newQuery => query = newQuery"/>
