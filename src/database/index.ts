	...
	constructor(
		...
		this.version(1)
			.stores({
				...
				furry_characters: '++id, illustration, name, species, species_alias, description, content',
				furry_events: '++id, cover, name, short_name, description, start_date, end_date, href, furry_character_ids',
