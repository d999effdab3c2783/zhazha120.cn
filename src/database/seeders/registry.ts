...
export default async (database: Dexie) => {
    database.table("registry").bulkAdd([
        ...
        },
        {
            ...
            _file: await (
                await alova
                    .Get<Response>((await import("@/assets/images/Z.svg?url")).default)
                    .send()
            ).blob(),
        },
        {
        ...
        },
        {
            ...
            value: (await import("@/assets/contents/self_description.md?raw")).default,
        },
        {
        ...
        },
        {
            ...
            value: ["pan.zhazha120.cn", "zhazha120.cn"],
        },
        {
        ...
        },
        {
            ...
            _file: await downloadBlob(
                (await import("@/assets/images/support/qq/qrcode.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/support/wechat/qrcode.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/support/alipay/red_packet.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/support/alipay/qrcode.webp?url")).default,
            ),
        },
        {
        ...
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/minecraft/panorama.webp?url")).default,
            ),
        },
        {
        ...
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/ball.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/cube.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/jetpack.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/robot.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/ship.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/spider.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/swing.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/ufo.webp?url")).default,
            ),
        },
        {
            ...
            value: `${config.reference_prefix}_file`,
            _file: await downloadBlob(
                (await import("@/assets/images/game/geometry_dash/wave.webp?url")).default,
            ),
        },
        {
        ...
        },
        {
            ...
            value: (await import("@/assets/contents/dev_description.md?raw")).default,
        },
        {
            name: "furry.description",
            value: (await import("@/assets/contents/furry_description.md?raw")).default,
        },
        {
            name: "self.birthday",
