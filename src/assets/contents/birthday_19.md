...
<custom-naive-vertical-stack>
	...
	<n-card size="small" title="祝福">
		<custom-naive-vertical-stack align="center">
			...
			<custom-naive-vertical-stack align="center">
				<n-image :src="publicAssets.find('@/assets/public/images/birthday/records/19/congratulate_1.webp').value"/>
				<n-image :src="publicAssets.find('@/assets/public/images/birthday/records/19/congratulate_2.webp').value"/>
			</custom-naive-vertical-stack>
		</custom-naive-vertical-stack>
	</n-card>
	...
	<n-card size="small" title="礼物">
		<custom-naive-vertical-stack align="center">
			<n-image :src="publicAssets.find('@/assets/public/images/birthday/records/19/gift_1.webp').value"/>
	...
	<n-card size="small" title="未完善的设定">
		<custom-naive-vertical-stack align="center" class="text-center">
			<n-image :src="publicAssets.find('@/assets/public/images/birthday/records/19/oc_1.webp').value"/>
	...
	<n-card size="small" title="收到的赠图">
		<custom-naive-vertical-stack align="center">
			<n-image :src="publicAssets.find('@/assets/public/images/birthday/records/19/manuscript_1.webp').value"/>
			...
			<n-image :src="publicAssets.find('@/assets/public/images/birthday/records/19/manuscript_2.webp').value"/>
			...
			<n-image :src="publicAssets.find('@/assets/public/images/birthday/records/19/manuscript_3.webp').value"/>
