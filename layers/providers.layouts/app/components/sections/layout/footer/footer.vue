	...
	<n-grid :cols="isMobile ? 1 : 5" :y-gap="10">
		...
		<n-grid-item>
			<NaivePosition class="size-full" placement="center">
				<n-flex align="center" size="small" vertical>
					<NaiveRedirectorWrapper #="{ href, redirect }" :href="appConfig.layout.footer.filing.icp.link">
						<n-button :href="href" tag="a" text type="warning" @click.prevent="redirect">
		...
		<n-grid-item>
			<NaivePosition class="size-full" placement="center">
				...
				>
					<n-button :href="href" size="small" tag="a" text type="info" @click.prevent="redirect">
						<template #icon>
