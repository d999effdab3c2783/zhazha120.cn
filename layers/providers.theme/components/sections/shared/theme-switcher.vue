<script lang="ts" setup>
	...
	const { define: ThemeSwitcherButtonDefine, reuse: ThemeSwitcherButton } = createReusableTemplate<
		{
...
<template>
	<ThemeSwitcherButtonDefine #="{ value, $slots }">
		<n-button :type="themeStore.mode === value ? 'primary' : 'default'" secondary @click="themeStore.mode = value">
			<template #icon>
